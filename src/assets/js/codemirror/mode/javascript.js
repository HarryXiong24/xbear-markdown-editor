...
CodeMirror.defineMode('javascript', defineJSMode);
CodeMirror.defineMode('js', defineJSMode);
...
CodeMirror.defineMIME('ts', {
  name: 'javascript',
  typescript: true,
});
const languages = ['js', 'json', 'python', 'py', 'react', 'coffeescript', 'dart', 'go', 'jsx'];
languages.forEach((item) => {
  CodeMirror.defineMIME(item, 'javascript');
});
